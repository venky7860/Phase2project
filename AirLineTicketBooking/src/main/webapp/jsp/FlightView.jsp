<%@page import="in.co.air.line.ticket.controller.FlightCtl"%>
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<form method="post" action="<%=ATBView.FLIGHT_CTL%>">
						<jsp:useBean id="bean"
							class="in.co.air.line.ticket.bean.FlightBean" scope="request"></jsp:useBean>
						...
						<div class="form-group required">
							<label class="control-label col-md-4  requiredField">Flight
							...
							<div class="controls col-md-8 ">
								<input class="input-md  textinput textInput form-control"
									...
									value="<%=DataUtility.getStringData(bean.getFlightNo())%>" />
						...
						<div class="form-group required">
							...
							<div class="controls col-md-8 ">
								<input class="input-md  textinput textInput form-control"
									...
									style="margin-bottom: 10px" type="text"
									value="<%=DataUtility.getStringData(bean.getFightName())%>" />
						...
						<div class="form-group required">
							...
							<div class="controls col-md-8 ">
								<input class="input-md  textinput textInput form-control"
									...
									style="margin-bottom: 10px" type="text"
									value="<%=DataUtility.getStringData(bean.getAirPortName())%>" />
