<%@page import="in.co.air.line.ticket.controller.BookCtl"%>
...
<div class="main-wrap">
					...
					FlightBean fBean=model.findByPK(flId);
...
<table class="table table-striped">
   ...
   <tbody>
      <tr>
         	<td ><b>Flight No.:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=fBean.getFlightNo()%> </td>
           	<td ><b>Flight Name:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=fBean.getFightName()%></td>
      ...
      <tr>
       ...
       <tr>
         	<td ><b>AirPort Name:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=fBean.getAirPortName()%></td>
   ...
   <tr>
      ...
      <tr>
       ...
       <tr>
         	<td colspan="2"><b>Final Amount:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$<%=fBean.getTicketPrice()*bBean.getNoOfPerson()%></td>
      </tr>
   </tbody>
